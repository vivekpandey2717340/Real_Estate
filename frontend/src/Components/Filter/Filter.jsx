                ...
                <div className="listing_div">
                    ...
                    <div className="listing_box">          
                        <div className="listing_photo">
                            <div className="image">
                                <img src="../src/assets/image/home.jpg" alt=""style={{boxShadow:'none'}}/>
                                <div className="sale_img">
                                    <img src="../src/assets/image/sale.png" alt=""/>
                                </div>
                                <div className="price">
                                    <div className="price_grid"style={{float:'right'}}>
                                        <h4 id="price">Rs.6.5 Crore</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="listing_content"> 
                            <h4 id="type">Home</h4>
                            <h3 id="content">House For Sale</h3>
                            <p id="location"><i className="fa-solid fa-location-dot"></i>Suncity,Pepsicola</p>
                            <p id="area"><i className="fa-solid fa-chart-area"></i>50 Sq.ft</p>
                            <Link >
                                <a>
