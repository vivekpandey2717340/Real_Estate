          ...
          <div className="new_properties_grid" style={{ paddingBottom: '50px' }}>
            <div id="specific_hot-section-container">
                {limitedHotProperties.map((item, index) => (
                    <PropertyItem key={index} id={item._id} title={item.title} price={item.price} address={item.address} content={item.content} area={item.area} mainImage={item.mainImage} saleImage={item.saleImage} roadAccess={item.roadAccess}/>
                ))}
            </div>
          </div>
            ...
            <div className="new_properties">
                ...
                <div id="specific_hot-section-container">
                    {limitedNewProperties.map((item, index) => (
                        <PropertyItem key={index} id={item._id} title={item.title} price={item.price} address={item.address} content={item.content} area={item.area} images={item.images} saleImage={item.saleImage} roadAccess={item.roadAccess}/>
                    ))}
                </div> 
                </div>
            </div>
